package net.merlono.merlonositems;

import com.mojang.logging.LogUtils;
import net.merlono.merlonositems.block.ModBlocks;
import net.merlono.merlonositems.item.ModCreativeModTabs;
...
@Mod(MerlonosItems.MOD_ID)
public class MerlonosItems
{
    public static final String MOD_ID = "merlonositems";
    private static final Logger LOGGER = LogUtils.getLogger();


    public MerlonosItems()
    {
